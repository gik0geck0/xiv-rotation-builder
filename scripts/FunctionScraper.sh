...
curl https://na.finalfantasyxiv.com/jobguide/paladin/ | sed '0,/Combo Sequence/!d' | sed -n '/<td class="content">/,/<\/td>/p' | sed -n '/<td class="content">/,/<\/td>/{ /<td class="content">/! { /<\/td>/! p}  } ' | sed '/<div/,/<\/div>/d' | sed 's/<\/a>//g' | sed 's/<\/div>//g' | sed '/^[[:space:]]*$/d' | sed -e 's/^[[:space:]]*//' -e 's/[[:space:]]*$//' | sed 's/$/\"/' | sed 's/^/\"/' > XIVEffect.txt
...
curl https://na.finalfantasyxiv.com/jobguide/warrior/ | sed '0,/Combo Sequence/!d'| sed -n '/<td class="content">/,/<\/td>/p' | sed -n '/<td class="content">/,/<\/td>/{ /<td class="content">/! { /<\/td>/! p}  } ' | sed '/<div/,/<\/div>/d' | sed 's/<\/a>//g' | sed 's/<\/div>//g' | sed '/^[[:space:]]*$/d' | sed -e 's/^[[:space:]]*//' -e 's/[[:space:]]*$//' | sed 's/$/\"/' | sed 's/^/\"/' > XIVEffect.txt
...
curl https://na.finalfantasyxiv.com/jobguide/darkknight/ | sed '0,/Combo Sequence/!d'| sed -n '/<td class="content">/,/<\/td>/p' | sed -n '/<td class="content">/,/<\/td>/{ /<td class="content">/! { /<\/td>/! p}  } ' | sed '/<div/,/<\/div>/d' | sed 's/<\/a>//g' | sed 's/<\/div>//g' | sed '/^[[:space:]]*$/d' | sed -e 's/^[[:space:]]*//' -e 's/[[:space:]]*$//' | sed 's/$/\"/' | sed 's/^/\"/' > XIVEffect.txt
...
curl https://na.finalfantasyxiv.com/jobguide/gunbreaker/ | sed '0,/Combo Sequence/!d'| sed -n '/<td class="content">/,/<\/td>/p' | sed -n '/<td class="content">/,/<\/td>/{ /<td class="content">/! { /<\/td>/! p}  } ' | sed '/<div/,/<\/div>/d' | sed 's/<\/a>//g' | sed 's/<\/div>//g' | sed '/^[[:space:]]*$/d' | sed -e 's/^[[:space:]]*//' -e 's/[[:space:]]*$//' | sed 's/$/\"/' | sed 's/^/\"/' > XIVEffect.txt
...
curl https://na.finalfantasyxiv.com/jobguide/whitemage/ | sed '0,/Simple Mode/!d'| sed -n '/<td class="content">/,/<\/td>/p' | sed -n '/<td class="content">/,/<\/td>/{ /<td class="content">/! { /<\/td>/! p}  } ' | sed '/<div/,/<\/div>/d' | sed 's/<\/a>//g' | sed 's/<\/div>//g' | sed '/^[[:space:]]*$/d' | sed -e 's/^[[:space:]]*//' -e 's/[[:space:]]*$//' | sed 's/$/\"/' | sed 's/^/\"/' > XIVEffect.txt
...
curl https://na.finalfantasyxiv.com/jobguide/sage/ | sed '0,/Simple Mode/!d'| sed -n '/<td class="content">/,/<\/td>/p' | sed -n '/<td class="content">/,/<\/td>/{ /<td class="content">/! { /<\/td>/! p}  } ' | sed '/<div/,/<\/div>/d' | sed 's/<\/a>//g' | sed 's/<\/div>//g' | sed '/^[[:space:]]*$/d' | sed -e 's/^[[:space:]]*//' -e 's/[[:space:]]*$//' | sed 's/$/\"/' | sed 's/^/\"/' > XIVEffect.txt
...
curl https://na.finalfantasyxiv.com/jobguide/monk/ | sed '0,/Changing Form/!d'| sed -n '/<td class="content">/,/<\/td>/p' | sed -n '/<td class="content">/,/<\/td>/{ /<td class="content">/! { /<\/td>/! p}  } ' | sed '/<div/,/<\/div>/d' | sed 's/<\/a>//g' | sed 's/<\/div>//g' | sed '/^[[:space:]]*$/d' | sed -e 's/^[[:space:]]*//' -e 's/[[:space:]]*$//' | sed 's/$/\"/' | sed 's/^/\"/' > XIVEffect.txt
...
curl https://na.finalfantasyxiv.com/jobguide/dragoon/ | sed '0,/Combo Sequence/!d'| sed -n '/<td class="content">/,/<\/td>/p' | sed -n '/<td class="content">/,/<\/td>/{ /<td class="content">/! { /<\/td>/! p}  } ' | sed '/<div/,/<\/div>/d' | sed 's/<\/a>//g' | sed 's/<\/div>//g' | sed '/^[[:space:]]*$/d' | sed -e 's/^[[:space:]]*//' -e 's/[[:space:]]*$//' | sed 's/$/\"/' | sed 's/^/\"/' > XIVEffect.txt
...
curl https://na.finalfantasyxiv.com/jobguide/reaper/ | sed '0,/Combo Sequence/!d'| sed -n '/<td class="content">/,/<\/td>/p' | sed -n '/<td class="content">/,/<\/td>/{ /<td class="content">/! { /<\/td>/! p}  } ' | sed '/<div/,/<\/div>/d' | sed 's/<\/a>//g' | sed 's/<\/div>//g' | sed '/^[[:space:]]*$/d' | sed -e 's/^[[:space:]]*//' -e 's/[[:space:]]*$//' | sed 's/$/\"/' | sed 's/^/\"/' > XIVEffect.txt
...
curl https://na.finalfantasyxiv.com/jobguide/bard/ | sed '0,/Simple Mode/!d'| sed -n '/<td class="content">/,/<\/td>/p' | sed -n '/<td class="content">/,/<\/td>/{ /<td class="content">/! { /<\/td>/! p}  } ' | sed '/<div/,/<\/div>/d' | sed 's/<\/a>//g' | sed 's/<\/div>//g' | sed '/^[[:space:]]*$/d' | sed -e 's/^[[:space:]]*//' -e 's/[[:space:]]*$//' | sed 's/$/\"/' | sed 's/^/\"/' > XIVEffect.txt
...
curl https://na.finalfantasyxiv.com/jobguide/machinist/ | sed '0,/Combo Sequence/!d'| sed -n '/<td class="content">/,/<\/td>/p' | sed -n '/<td class="content">/,/<\/td>/{ /<td class="content">/! { /<\/td>/! p}  } ' | sed '/<div/,/<\/div>/d' | sed 's/<\/a>//g' | sed 's/<\/div>//g' | sed '/^[[:space:]]*$/d' | sed -e 's/^[[:space:]]*//' -e 's/[[:space:]]*$//' | sed 's/$/\"/' | sed 's/^/\"/' > XIVEffect.txt
...
curl https://na.finalfantasyxiv.com/jobguide/blackmage/ | sed '0,/Combo Sequence/!d'| sed -n '/<td class="content">/,/<\/td>/p' | sed -n '/<td class="content">/,/<\/td>/{ /<td class="content">/! { /<\/td>/! p}  } ' | sed '/<div/,/<\/div>/d' | sed 's/<\/a>//g' | sed 's/<\/div>//g' | sed '/^[[:space:]]*$/d' | sed -e 's/^[[:space:]]*//' -e 's/[[:space:]]*$//' | sed 's/$/\"/' | sed 's/^/\"/' > XIVEffect.txt
...
curl https://na.finalfantasyxiv.com/jobguide/redmage/ | sed '0,/Combo Sequence/!d'| sed -n '/<td class="content">/,/<\/td>/p' | sed -n '/<td class="content">/,/<\/td>/{ /<td class="content">/! { /<\/td>/! p}  } ' | sed '/<div/,/<\/div>/d' | sed 's/<\/a>//g' | sed 's/<\/div>//g' | sed '/^[[:space:]]*$/d' | sed -e 's/^[[:space:]]*//' -e 's/[[:space:]]*$//' | sed 's/$/\"/' | sed 's/^/\"/' > XIVEffect.txt
